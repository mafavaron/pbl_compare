...
program GenerateIndicators
    ...
    ! -1- Case 1
    open(10, file="Indices_1.csv", status="unknown", action="write")
    write(10, "('Variant, Value, FB, NMSE, MG, VG, FAC2')")
    do i=1,N_VARS
        write(10, "(i1,',',f5.1,5(',',f11.5))") &
            i-1, rvVariantValue(i), rmFB(i,1), rmNMSE(i,1), rmMG(i,1), rmVG(i,1), rmFAC2(i,1)
    end do
    close(10)
    ! -1- Case 2
    open(10, file="Indices_2.csv", status="unknown", action="write")
    ...
    do i=1,N_VARS
        write(10, "(i1,',',f5.1,5(',',f11.5))") &
            i-1, rvVariantValue(i), rmFB(i,2), rmNMSE(i,2), rmMG(i,2), rmVG(i,2), rmFAC2(i,2)
    end do
    close(10)
